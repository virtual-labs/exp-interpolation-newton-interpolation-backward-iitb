...
function start_act3() {
    ...
    <p style='text-align: center; font-size: 24px;'>Find <span style='display: inline-block;' >$$ f(${x_ex}) $$</span> by Interpolation</p>
        ...
        <div style='text-align: center;'><span style='font-size: 24px; display: inline-block;'>$$ u \\ = \\ \\frac{x - x_3}{h} $$</span> = <input type='number' class='form-control' style='display: inline !important; width: 120px;' id='u2-inp' > <span id='u2-val-sp'></span></div>

        <div style='text-align: center;'><span style='font-size: 24px; display: inline-block;'>$$ y = f(x) = y_3 + \\frac{u\\Delta_4^1}{1!} + \\frac{u(u+1)\\Delta_4^2}{2!} + \\frac{u(u+1)(u+2)\\Delta_4^3}{3!} $$</span></div>
...
function verify_a3() {
    ...
    if (!verify_values(parseFloat(inp.value), (x_ex - X[3]))) {
