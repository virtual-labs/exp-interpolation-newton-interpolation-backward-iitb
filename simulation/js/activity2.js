...
function start_act2() {
    ...
    <div class='collapse divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb2-box'>
        ...
        <div style='text-align: center;'><span style='font-size: 24px; display: inline-block;'>$$ u \\ = \\ \\frac{x - x_4}{h} $$</span> = <input type='number' class='form-control' style='display: inline !important; width: 120px;' id='u-inp' > <span id='u-val-sp'></span></div>

        <div style='text-align: center;'><span style='font-size: 24px; display: inline-block;'>$$ y = f(x) = y_4 + \\frac{u\\Delta_4^1}{1!} + \\frac{u(u+1)\\Delta_4^2}{2!} + \\frac{u(u+1)(u+2)\\Delta_4^3}{3!} $$</span></div>
...
function verify_a2() {
    ...
    if (!verify_values(parseFloat(inp.value), (x - X[3]))) {
